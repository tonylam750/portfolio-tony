import {
  ...
  useDrag
} from "./chunk-6BD5DFHE.js";
import {
  require_react_dom
} from "./chunk-YY7WWNM7.js";
import {
  _extends,
  create
} from "./chunk-MBRIE3RN.js";
import {
  require_react
} from "./chunk-QZ3WWBGT.js";
import {
  __commonJS,
  __toESM
...
var require_is_plain_object = __commonJS({
  "node_modules/.pnpm/is-plain-object@2.0.4/node_modules/is-plain-object/index.js"(exports, module) {
    ...
    module.exports = function isPlainObject(o9) {
      var ctor, prot;
      if (isObjectObject(o9) === false) return false;
      ctor = o9.constructor;
...
// node_modules/.pnpm/leva@0.9.33_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/leva/dist/vector-plugin-325f50f2.esm.js
var import_react_dom3 = __toESM(require_react_dom());
var import_react2 = __toESM(require_react());

// node_modules/.pnpm/@radix-ui+react-compose-refs@0.1.0_react@18.2.0/node_modules/@radix-ui/react-compose-refs/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-slot@0.1.2_react@18.2.0/node_modules/@radix-ui/react-slot/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-primitive@0.1.4_react@18.2.0/node_modules/@radix-ui/react-primitive/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-use-layout-effect@0.1.0_react@18.2.0/node_modules/@radix-ui/react-use-layout-effect/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-portal@0.1.4_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@radix-ui/react-portal/dist/index.module.js
...
var a = (e12) => {
  for (const t12 in e12) return true;
  return false;
};
    ...
    const p5 = (e14) => {
      for (c6 in e14) {
        ...
        for (g5 of z2) {
          ...
          } else void 0 === o9 && (o9 = [[], t13, r15]), c6 = R3 || 36 !== c6.charCodeAt(0) ? c6 : `--${S(n6.prefix)}${c6.slice(1).replace(/\$/g, "-")}`, g5 = z3 ? g5 : "number" == typeof g5 ? g5 && e15 in I ? String(g5) + "px" : String(g5) : k(m(e15, null == g5 ? "" : g5), n6.prefix, n6.themeMap[e15]), o9[0].push(`${R3 ? `${c6} ` : `${d(c6)}:`}${g5}`);
        }
      }
      var b5, $4;
    };
...
var z = (e12) => ((e13) => {
  let t12, r14 = "";
  for (t12 = Math.abs(e13); t12 > 52; t12 = t12 / 52 | 0) r14 = R(t12 % 52) + r14;
  return R(t12 % 52) + r14;
})(((e13, t12) => {
  let r14 = t12.length;
  for (; r14; ) e13 = 33 * e13 ^ t12.charCodeAt(--r14);
  return e13;
})(5381, JSON.stringify(e12)) >>> 0);
var W = ["themed", "global", "styled", "onevar", "resonevar", "allvar", "inline"];
var j = (e12) => {
  if (e12.href && !e12.href.startsWith(location.origin)) return false;
  try {
    return !!e12.cssRules;
  } catch (e13) {
    return false;
  ...
  const r14 = () => {
    ...
    return [].map.call(e13, (r15, n7) => {
      ...
      if (e13[n7 - 1] && (o9 = e13[n7 - 1].cssText).startsWith("--sxs")) {
        ...
        for (const e14 in t12.rules) if (t12.rules[e14].group === r15) return `--sxs{--sxs:${[...t12.rules[e14].cache].join(" ")}}${i6}`;
...
var M = (e12, t12) => w(e12, () => (...r14) => {
  ...
  for (const t13 of r14) if (null != t13) if (t13[l2]) {
    null == n6.type && (n6.type = t13[l2].type);
    for (const e13 of t13[l2].composers) n6.composers.add(e13);
  } else t13.constructor !== Object || t13.$$typeof ? null == n6.type && (n6.type = t13) : n6.composers.add(C(t13, e12));
...
var C = ({ variants: e12, compoundVariants: t12, defaultVariants: r14, ...n6 }, i6) => {
  ...
  for (const e13 in r14) d5[e13] = String(r14[e13]);
  if ("object" == typeof e12 && e12) for (const t13 in e12) {
  ...
  var p5, u5;
  if ("object" == typeof t12 && t12) for (const e13 of t12) {
    let { css: t13, ...r15 } = e13;
    t13 = "object" == typeof t13 && t13 || {};
    for (const e14 in r15) r15[e14] = String(r15[e14]);
...
var P = (e12, t12, r14) => {
  const [n6, i6, o9, a5] = L(t12.composers), c6 = "function" == typeof t12.type || t12.type.$$typeof ? ((e13) => {
    ...
    for (const e13 in o9) if (delete p6[e13], e13 in l6) {
      let t13 = l6[e13];
    ...
    for (const [n7, i7, o10, l7] of t12.composers) {
      ...
      for (const i8 of t13) if (void 0 !== i8) for (const [t14, o11, l8] of i8) {
      ...
      for (const t14 of s7) if (void 0 !== t14) for (const [i8, o11] of t14) {
    ...
    for (const e13 of String(l6.className || "").trim().split(/\s+/)) e13 && h5.add(e13);
    ...
    for (e13 in o9) {
      ...
      if (i7 !== n7) {
        if ("object" != typeof i7 || !i7) continue e;
        {
          ...
          if (t13 && t13.length && (l6 = { ["@media " + t13.join(", ")]: l6 }), !e14) continue e;
        }
      }
    }
    ...
    for (let n7 of r14) {
      ...
      if (!t12.rules.global.cache.has(r15)) {
        if (t12.rules.global.cache.add(r15), "@import" in n7) {
          ...
          for (let r16 of [].concat(n7["@import"])) r16 = r16.includes('"') || r16.includes("'") ? r16 : `"${r16}"`, t12.sheet.insertRule(`@import ${r16};`, e13++);
          delete n7["@import"];
        }
        $(n7, [], [], e12, (e13) => {
...
// node_modules/.pnpm/@radix-ui+react-id@0.1.4_react@18.2.0/node_modules/@radix-ui/react-id/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-primitive@0.1.3_react@18.2.0/node_modules/@radix-ui/react-primitive/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-visually-hidden@0.1.3_react@18.2.0/node_modules/@radix-ui/react-visually-hidden/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-portal@0.1.3_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@radix-ui/react-portal/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-arrow@0.1.3_react@18.2.0/node_modules/@radix-ui/react-arrow/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-use-size@0.1.0_react@18.2.0/node_modules/@radix-ui/react-use-size/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+rect@0.1.1/node_modules/@radix-ui/rect/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-use-rect@0.1.1_react@18.2.0/node_modules/@radix-ui/react-use-rect/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-context@0.1.1_react@18.2.0/node_modules/@radix-ui/react-context/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+popper@0.1.0/node_modules/@radix-ui/popper/dist/index.module.js
function getPlacementData({ anchorRect: p5, popperSize: c6, arrowSize: f5, arrowOffset: l6 = 0, side: d5, sideOffset: h5 = 0, align: x4, alignOffset: g5 = 0, shouldAvoidCollisions: u5 = true, collisionBoundariesRect: w4, collisionTolerance: m5 = 0 }) {
  if (!p5 || !c6 || !w4) return { popperStyles: o6, arrowStyles: n3 };
  ...
  const R3 = s2(S4, $4), M3 = y5[a2(d5)][x4], D2 = function(t12, e12, r14) {
    ...
    if (("start" === o9 || "center" === o9) && (n6[p6] && c7 || n6[a5] && !c7)) return "end";
    if (("end" === o9 || "center" === o9) && (n6[a5] && c7 || n6[p6] && !c7)) return "start";
    return o9;
...
// node_modules/.pnpm/@radix-ui+react-popper@0.1.3_react@18.2.0/node_modules/@radix-ui/react-popper/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-presence@0.1.1_react@18.2.0/node_modules/@radix-ui/react-presence/dist/index.module.js
  ...
  const { present: o9, children: i6 } = u5, s6 = function(n6) {
    ...
    return t7.useEffect(() => {
      ...
      if (t12 !== n6) {
        ...
        if (n6) m5("MOUNT");
        else if ("none" === o11 || "none" === (null == e12 ? void 0 : e12.display)) m5("UNMOUNT");
        else {
          const e13 = u7 !== o11;
...
// node_modules/.pnpm/@radix-ui+react-use-previous@0.1.0_react@18.2.0/node_modules/@radix-ui/react-use-previous/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-use-callback-ref@0.1.0_react@18.2.0/node_modules/@radix-ui/react-use-callback-ref/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-use-escape-keydown@0.1.0_react@18.2.0/node_modules/@radix-ui/react-use-escape-keydown/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+react-use-controllable-state@0.1.0_react@18.2.0/node_modules/@radix-ui/react-use-controllable-state/dist/index.module.js
...
// node_modules/.pnpm/@radix-ui+primitive@0.1.0/node_modules/@radix-ui/primitive/dist/index.module.js
function composeEventHandlers(e12, n6, { checkForDefaultPrevented: t12 = true } = {}) {
  return function(r14) {
    if (null == e12 || e12(r14), false === t12 || !r14.defaultPrevented) return null == n6 ? void 0 : n6(r14);
  };
}

// node_modules/.pnpm/@radix-ui+react-tooltip@0.1.6_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/@radix-ui/react-tooltip/dist/index.module.js
...
function getVectorSchema(dimension) {
  ...
  const isVectorObject = (o9) => {
    if (!o9 || typeof o9 !== "object") return false;
...
function names_default(e12, f5) {
  ...
  e12.prototype.toName = function(f6) {
    ...
    if (null == f6 ? void 0 : f6.closest) {
      ...
      if (!l6.length) for (var c6 in a5) l6[c6] = new e12(a5[c6]).toRgb();
      for (var g5 in a5) {
...
// node_modules/.pnpm/leva@0.9.33_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/leva/dist/leva.esm.js
var import_react_dom4 = __toESM(require_react_dom());
var import_react7 = __toESM(require_react());

// node_modules/.pnpm/react-colorful@5.6.1_react-dom@18.2.0_react@18.2.0__react@18.2.0/node_modules/react-colorful/dist/index.mjs
var import_react5 = __toESM(require_react(), 1);
function u4() {
  return (u4 = Object.assign || function(e12) {
    for (var r14 = 1; r14 < arguments.length; r14++) {
      var t12 = arguments[r14];
      for (var n6 in t12) Object.prototype.hasOwnProperty.call(t12, n6) && (e12[n6] = t12[n6]);
    }
    return e12;
...
function c5(e12, r14) {
  ...
  for (n6 = 0; n6 < a5.length; n6++) r14.indexOf(t12 = a5[n6]) >= 0 || (o9[t12] = e12[t12]);
  return o9;
}
function i5(e12) {
...
var d4 = function(e12, r14, t12) {
  var n6 = e12.getBoundingClientRect(), o9 = f4(r14) ? function(e13, r15) {
    for (var t13 = 0; t13 < e13.length; t13++) if (e13[t13].identifier === r15) return e13[t13];
    return e13[0];
  }(r14.touches, t12) : r14;
...
var F2 = function(e12, r14) {
  if (e12 === r14) return true;
  for (var t12 in e12) if (e12[t12] !== r14[t12]) return false;
  return true;
};
...
// node_modules/.pnpm/react-dropzone@12.1.0_react@18.2.0/node_modules/react-dropzone/dist/es/index.js
...
function __generator(thisArg, body) {
  var _3 = { label: 0, sent: function() {
    if (t12[0] & 1) throw t12[1];
    return t12[1];
  }, trys: [], ops: [] }, f5, y5, t12, g5 = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
  ...
  function step(op) {
    ...
    while (g5 && (g5 = 0, op[0] && (_3 = 0)), _3) try {
      if (f5 = 1, y5 && (t12 = op[0] & 2 ? y5["return"] : op[0] ? y5["throw"] || ((t12 = y5["return"]) && t12.call(y5), 0) : y5.next) && !(t12 = t12.call(y5, op[1])).done) return t12;
      if (y5 = 0, t12) op = [op[0] & 2, t12.value];
      switch (op[0]) {
        case 0:
        case 1:
          t12 = op;
...
function __read(o9, n6) {
  ...
  try {
    while ((n6 === void 0 || n6-- > 0) && !(r14 = i6.next()).done) ar.push(r14.value);
  } catch (error) {
    e12 = { error };
  } finally {
    try {
...
// node_modules/.pnpm/react-dropzone@12.1.0_react@18.2.0/node_modules/react-dropzone/dist/es/utils/index.js
...
function _unsupportedIterableToArray(o9, minLen) {
  ...
  if (n6 === "Object" && o9.constructor) n6 = o9.constructor.name;
  if (n6 === "Map" || n6 === "Set") return Array.from(o9);
  if (n6 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n6)) return _arrayLikeToArray(o9, minLen);
}
...
function _unsupportedIterableToArray2(o9, minLen) {
  if (!o9) return;
  if (typeof o9 === "string") return _arrayLikeToArray2(o9, minLen);
  var n6 = Object.prototype.toString.call(o9).slice(8, -1);
  if (n6 === "Object" && o9.constructor) n6 = o9.constructor.name;
  if (n6 === "Map" || n6 === "Set") return Array.from(o9);
  if (n6 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n6)) return _arrayLikeToArray2(o9, minLen);
}
...
var Store = function Store2() {
  ...
  this.getVisiblePaths = () => {
    ...
    Object.entries(folders).forEach(([path, settings]) => {
      if (settings.render && paths.some((p5) => p5.indexOf(path) === 0) && !settings.render(this.get)) hiddenFolders.push(path + ".");
    });
    const visiblePaths = [];
